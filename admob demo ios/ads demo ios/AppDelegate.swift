...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        GADMobileAds.configure(withApplicationID: Values.appId)
        let mainController = self.window?.rootViewController
        GADRewardBasedVideoAd.sharedInstance().delegate = mainController as! ViewController
        let req = GADRequest()
